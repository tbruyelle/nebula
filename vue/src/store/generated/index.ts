...
import TbruyelleNebulaTbruyelleNebulaSbt from './tbruyelle/nebula/tbruyelle.nebula.sbt'
...
export default { 
  ...
  TbruyelleNebulaTbruyelleNebulaSbt: load(TbruyelleNebulaTbruyelleNebulaSbt, 'tbruyelle.nebula.sbt'),
