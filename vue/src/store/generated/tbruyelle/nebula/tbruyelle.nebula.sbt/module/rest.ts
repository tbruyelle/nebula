...
export interface SbtMsgBindSoulResponse {
  /** @format uint64 */
  id?: string;
}

export interface SbtMsgCreateSoulResponse {
  /** @format uint64 */
  id?: string;
}
 ...
 */
export type SbtParams = object;

/**
 * QueryParamsResponse is response type for the Query/Params RPC method.
 */
export interface SbtQueryParamsResponse {
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/tbruyelle/nebula/sbt/params
   */
   ...
   * @tags Query
   * @name QuerySouls
   * @summary Queries a list of Souls items.
   * @request GET:/tbruyelle/nebula/sbt/souls/{creator}
   */
  querySouls = (
    creator: string,
    query?: {
    ...
    this.request<SbtQuerySoulsResponse, RpcStatus>({
      path: `/tbruyelle/nebula/sbt/souls/${creator}`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
